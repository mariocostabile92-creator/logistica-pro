...
test("cache busting reaches the DSP shell and Q7 Driver module", async () => {
  ...
  assert.match(loader, /dsp-shell\/index\.js\?v=14/);
  assert.match(shell, /dsp-quality\/index\.js\?v=14/);
  assert.match(controller, /presenter\.js\?v=9/);
  assert.match(presenter, /drivers-presenter\.js\?v=4/);
});
