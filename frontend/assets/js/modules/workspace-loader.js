...
const STYLES = {
  operations: [
    "planning-workspace.css?v=fleet21",
  ],
  "operations-legacy": [
    "fleet-sync.css",
    "excel-import.css",
  ...
  workforce: [
    ...
    "workforce-calendar.css?v=6",
    "workforce-coverage-board.css?v=1",
    "workforce-day-planner.css?v=2",
    "workforce-panel.css?v=6",
  ...
  dsp: ["dsp-workspace.css?v=7", "dsp-quality.css?v=16"],
  fleet: [
    "fleet.css",
    "fleet-sync.css",
  ],
  "fleet-secondary": [
    "damage-workspace.css?v=7",
...
const WORKSPACE_PREPARERS = {
  operations: async () => {
    const [planningWorkspace] = await Promise.all([
      import("./planning-workspace/index.js?v=fleet21"),
  ...
  dsp: async () => {
    const [module] = await Promise.all([
      import("./dsp-shell/index.js?v=20"),
      loadWorkspaceStyles("dsp"),
    ]);
    return async () => {
      module.initDspShell();
      await module.prepareDspShellFirstPaint();
    };
  },
  fleet: async () => {
    const [module, fleetSync] = await Promise.all([
      import("./fleet-page.js?v=30"),
