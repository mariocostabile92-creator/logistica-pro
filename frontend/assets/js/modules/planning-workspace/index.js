...
import { createPlanningWorkspaceLayout } from "./layout.js?v=forecast2";
import {
  readinessEventType,
} from "./readiness.js";
...
import { openPlanningOperationsDate } from "../planning-operations/index.js?v=forecast2";
...
export async function openPlanningDate(planningDate) {
  ...
  await openPlanningOperationsDate(normalized);
