...
from app.plugins.fleet.journal.control_room.shared_access_router import (
    router as shared_access_router,
)
...
def register_fleet_plugin(app: FastAPI) -> None:
    if fleet_plugin_enabled():
        ...
        app.include_router(journal_archive_router)
        app.include_router(journal_integrity_router)
