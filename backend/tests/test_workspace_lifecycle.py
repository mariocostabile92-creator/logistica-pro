    ...
    added_paths = {
        ...
        for path in paths
                        ...
                        or path.startswith("/api/fleet/damage")
                            ...
                            or path.startswith("/api/fleet/documents")
                            or path.startswith("/api/fleet/franchises")
                            ...
                            or path.startswith("/api/fleet/deadlines")
                                ...
                                or path.startswith("/api/fleet/journal-archive")
                                or path.startswith("/api/fleet/journal-integrity")
                            or path.startswith("/api/fleet/vision")
        ...
        in {
                ...
                "/api/dsp-quality/followups",
                "/api/dsp-quality/followups/{followup_id}",
                "/api/dsp-quality/followups/{followup_id}/close",
...
def test_operational_and_preserved_table_classification_is_complete():
    assert workspace_repository.OPERATIONAL_DELETE_ORDER == (
        ...
        "workforce_external_identity_events",
        "workforce_external_identities",
        "dsp_quality_followup_events",
        "dsp_quality_followups",
